...
# ======================
# A "transform" in this context is an operation that re-maps every point :math:`v \in V^n` to
# another point in :math:`V^n`. test 1 2 3.
# A linear transformation :math:`L` has the further constraint that ldldldldld
#    
